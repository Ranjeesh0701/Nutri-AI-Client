...
const Diet = ({timeFrame, setTimeFrame, calorie, setCalorie,glutenFree, setGlutenFree, vegetarian, setVegetarian, ketogenic, setKetogenic, currentMeal, setCurrentMeal, selectedMeal, setSelectedMeal, customPlan, setCustomPlan, customDiet, setCustomDiet, createDietPlan, addCustomMealField, deleteCustomMeal, updateValue, updateCustomMealTime, saveCustomPlan, dietLoading, savedDiet, changePlan, saveSuggestedPlan}:any) => {
                                ...
                                <>
                                    {
                                        savedDiet.isCustomDiet === true ? (
                                            <div className='py-4 pt-10 px-10'>
                                                <p className='pb-6 text-white font-bold'>Current Plan<button className='bg-green-400 px-2 py-2 rounded-lg text-xs ml-4 text-black' onClick={() => setIsOpen(true)}>Change plan</button></p>
            ...
            <div className="fixed inset-0 z-10 overflow-y-auto">
                ...
                >
                    ...
                    <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                        ...
                        onClick={() => {changePlan(); setIsOpen(false)}}
                        >
                        Change plan
                        </button>
                        <button
